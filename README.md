...
The file **`table2_final.py`** (or `benchmark_table2.py` – please use the exact filename in this repository) **outputs the exact numerical values presented in Table 2 of the paper.**  
